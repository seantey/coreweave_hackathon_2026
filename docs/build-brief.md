...
| Spark + Three.js | Render splats and meshes, position inspection cameras, apply visual edits, place assets | Viewer renders chair splats, a remote RAD bedroom fixture, and layered Hunyuan meshes. The panorama-based office now renders with projected textures and six separately addressable chair candidates. Geometry defects remain visible; the earlier ordinary-photo experiment was rejected for projection distortion. |
